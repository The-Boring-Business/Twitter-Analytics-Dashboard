...
nav_item = dbc.NavItem(dbc.NavLink("Github Repository", href="https://github.com/The-Boring-Business/Twitter-Analytics-Dashboard", target="_blank", style={"color":"white"}))

dropdown = dbc.DropdownMenu(
    children=[
        dbc.DropdownMenuItem("Jeevanshi Sharma", href="https://github.com/Femme-js" ,target="_blank")
    ...
    dbc.Container(
        [
            html.A(
                dbc.Row(
                    [
                        dbc.Col(dbc.NavbarBrand("Your Twitter Analytics", className="ml-2")),
                    ],
                    align="center",
                    no_gutters=True,
                ),
